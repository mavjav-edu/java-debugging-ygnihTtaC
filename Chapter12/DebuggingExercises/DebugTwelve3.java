...
public class DebugTwelve3
{
   public static void main(String[] args)
   {
      ...
      try
      {
         ...
         {
            result =  array[x] / num;
            JOptionPane.showMessageDialog(null, "Result of division is " + result, "Error", JOptionPane.ERROR_MESSAGE);
            result = array[num];
            JOptionPane.showMessageDialog(null, "Result accessing array is " + result, "Error", JOptionPane.ERROR_MESSAGE);
         }
      }
